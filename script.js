document.addEventListener('DOMContentLoaded', () => {
    ...
    const masterTracks = [
        // --- PWRDCNV (from audios/sec noon/) ---
        {
            ...
            artist: "10:48- 11:10",
            src: "./audios/sec noon/generator talking on the day of powercut.mp3",
            category: "PWRDCNV",
        ...
        },
        {
            ...
            artist: "11:15 - 12:10",
            src: "./audios/sec noon/normally talking of office shits.mp3",
            category: "PWRDCNV",
        ...
        },
        {
            ...
            artist: "12:10-13:14",
            src: "./audios/sec noon/talking about sharanya for leaving on the power cut.mp3",
            category: "PWRDCNV",
        ...
        },
        {
            ...
            artist: "13:50- 14:32",
            src: "./audios/sec noon/free speech on project they were talking.mp3",
            category: "PWRDCNV",
        ...
        },
        {
            ...
            artist: "14:30 15:00",
            src: "./audios/sec noon/thikas preception on us doing nothing not working.mp3",
            category: "PWRDCNV",
        ...
        },
        {
            ...
            artist: "15:00 16:20",
            src: "./audios/sec noon/sujay saying they need to spoon feed and praksh sir did nothing.mp3",
            category: "PWRDCNV",
        ...
        },
        {
            ...
            artist: "17:50-19:00",
            src: "./audios/sec noon/sujay saying he observes everything.mp3",
            category: "PWRDCNV",
        ...
        },
        {
            ...
            artist: "19:00 - 22:38",
            src: "./audios/sec noon/thika and sujay talking about qgis shits it might fun to hear.mp3",
            category: "PWRDCNV",
        ...
        },
        {
            ...
            artist: "22:38 - 23:31",
            src: "./audios/sec noon/they were talking about moving sharanya to lidar and about the place changing.mp3",
            category: "PWRDCNV",
        ...
        },
        {
            ...
            artist: "24:10 25:00",
            src: "./audios/sec noon/dedicated employee deekshit and pratham.mp3",
            category: "PWRDCNV",
        ...
        },
        {
            ...
            artist: "25:00-26:40",
            src: "./audios/sec noon/talking about tl and about projects.mp3",
            category: "PWRDCNV",
        ...
        },
        {
            ...
            artist: "23:33 - 23:40",
            src: "./audios/sec noon/sujay saying i'm manipulating sharanya.mp3",
            category: "PWRDCNV",
        ...
        },
        {
            ...
            artist: "31:58-32:44",
            src: "./audios/sec noon/savitha saying we are mobile addict and thika saying not turning on the light.mp3",
            category: "PWRDCNV",
        ...
        },
        {
            ...
            artist: "PWRDCNV Misc",
            src: "./audios/sec noon/diseal and gen some other things u can hear if u want to.mp3",
            category: "PWRDCNV",
        ...
        },
        {
            ...
            src: "./audios/sec noon/full audio denoised of the thika convo.mp3",
            category: "PWRDCNV",
        ...
        // --- MCNV (from audios/morning/) ---
        {
            title: "sujay denying he said kalla to Sanjay",
            artist: "MCNV Morning",
            src: "./audios/morning/sujay denying he said kalla to sanjay.mp3",
            category: "MCNV",
        ...
        },
        {
            ...
            artist: "MCNV Morning",
            src: "./audios/morning/sujay denying me manipulating sharnaya said.mp3",
            category: "MCNV",
        ...
        },
        {
            ...
            artist: "MCNV Morning",
            src: "./audios/morning/they saying they wont talk behind our back.mp3",
            category: "MCNV",
        ...
        },
        {
            ...
            artist: "MCNV Morning",
            src: "./audios/morning/chir sala ex start.mp3",
            category: "MCNV",
        ...
        },
        {
            ...
            artist: "MCNV Morning",
            src: "./audios/morning/full audio on Monday office convo.mp3",
            category: "MCNV",
        ...
        },
        {
            ...
            artist: "MCNV Morning",
            src: "./audios/morning/tool never allowed to delete, brain knowledge and things.mp3",
            category: "MCNV",
        ...
        // --- Call Recordings (from audios/call/) ---
        {
            title: "Sujay Sir 26-05-2025 3.04 pm",
            artist: "Call Recording",
            src: "./audios/call/Sujay Sir 26-05-2025 3.04 pm call recording.mp3",
            category: "Call",
        ...
        },
        {
            ...
            artist: "Call Recording",
            src: "./audios/call/Sujay Sir 26-05-2025 5.32 pm call recording.mp3",
            category: "Call",
        ...
        },
        {
            ...
            artist: "Call Recording",
            src: "./audios/call/Sujay Sir 27-05-2025 6.10 pm call recording.mp3",
            category: "Call",
            description: "Call recording with Sujay Sir on 27-05-2025 at 6.10 PM."
        }
    ]; // End of masterTracks array
    ...
    function actuallyPlayAudio() {
        ...
        if (playPromise !== undefined) {
            playPromise.then(() => {
                ...
                let anchorElementForScroll = trackTitleDisplay;

                if (externalTrackDescriptionArea &&
                    externalTrackDescriptionArea.style.display !== 'none' &&
                    externalTrackDescriptionArea.offsetParent !== null) {
                    anchorElementForScroll = externalTrackDescriptionArea;
                }

                if (anchorElementForScroll) {
                    const scrollTarget = anchorElementForScroll.parentElement || anchorElementForScroll;
                ...
                // *** END OF MODIFIED SCROLLING LOGIC ***
    ...
    function filterPlaylist(category) {
        ...
        const activeFilterButton = document.querySelector(`.filter-btn[data-filter="${category}"]`);
        ...
        if (currentTracklist.length > 0) {
            ...
            const stillPlayingTrackIndex = currentTracklist.findIndex(track => new URL(track.src, window.location.href).href === new URL(currentAudioSrc, window.location.href).href);
    ...
    audio.addEventListener('error', (e) => {
        ...
        if (audio.error) { /* e.g., audio.error.code */ }
        displayTrackError(errorMsg);
        trackTitleDisplay.textContent = "Error";
        trackArtistDisplay.textContent = currentTracklist[currentTrackIndex]?.artist || "Unknown Artist";
    ...
    eqSliders.forEach(slider => { slider.addEventListener('input', () => { manualEQChange(); }); });
    if(resetEqBtn) { resetEqBtn.addEventListener('click', () => { applyFlatPreset(); }); }
    presetButtons.forEach(button => { button.addEventListener('click', () => { const presetName = button.dataset.preset; if (eqPresets[presetName]) { applyEQGains(eqPresets[presetName]); setActivePresetButton(presetName); } }); });
    filterButtons.forEach(button => { button.addEventListener('click', () => filterPlaylist(button.dataset.filter)); });

    function initializePlayer() {
        applyEQGains(defaultEQSettings.gains);
        setActivePresetButton(defaultEQSettings.presetName);
